...
const PurchaseInvoice = () => {
    ...
    useEffect(() => {
        handleManipulateDropdown(3, true)
        fetchDataFromDB()
    }, [])
        ...
        <PageWapper className="!bg-transparent !shadow-none">
            ...
            {activeTab === 'creation' && (
                <div className="flex flex-col gap-7">
                    <MasterBox title='Purchase Invoice Creation' masterConfig={TransactionMasterConfig} onPress={(values) => createTransactionInDb(values, items, setActiveTab)} fetchData={fetchDataFromDB} />
