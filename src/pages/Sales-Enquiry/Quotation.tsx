    ...
    <PageWapper className="!bg-transparent !shadow-none">
      ...
      <div id="printArea" style={{ display: 'none' }}>
        { printResult && <>
          ...
          <tr>				
            <td colSpan={3} style={{textAlign: "center",fontSize: "28px",fontWeight:"bold",color:"#7A91BB"}} >Quotation Order</td>
          </tr>
          <tr>
            <td> 
          ...
          <tr>
            <td></td>
            <td colSpan={4}>
              If you have any questions about the quotation order, Please contact [CONTACT_NAME] [CONTACT_PHONE] [CONTACT_EMAIL]	
            </td>
            <td></td>
          </tr>			
          </table>
