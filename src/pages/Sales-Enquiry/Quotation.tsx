...
import { QuotationDetailsConfig, QuotationMasterConfig } from './QuotationConfig'
...
type CreationRow = {
  [K in (typeof QuotationMasterConfig)[number] as K['id']]: string
}

const columns: ColumnDef<CreationRow>[] = QuotationMasterConfig.map(field => ({
...
const Quotation = () => {
  const sections: Section[] = [
    { title: 'Quotations Listing', key: 'listing' },
    { title: 'Quotations Creation', key: 'creation' },
  ]
    ...
    <PageWapper className="!bg-transparent !shadow-none">
      ...
      {activeTab === 'listing' && (
        <div className="flex flex-col gap-4 bg-white p-4 rounded-lg h-fit">
          <h1 className="text-2xl font-medium text-zinc-700 uppercase">Quotations</h1>
        ...
        <div className="flex flex-col gap-7">
          <div className="flex flex-col justify-between gap-4 bg-white p-4 rounded-lg flex-grow">
            ...
            <DynamicForm
              ...
              fieldConfig={QuotationMasterConfig}
          ...
          <div className="flex flex-col justify-between gap-4 bg-white p-4 rounded-lg flex-grow">
            ...
            <DynamicForm
              ...
              fieldConfig={QuotationDetailsConfig}
            ...
            {items.length > 0 && (
              <div className="bg-white p-4 rounded-lg">
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      {QuotationDetailsConfig.map(field => (
