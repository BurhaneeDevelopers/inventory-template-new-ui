...
export const QuotationMasterConfig: FieldConfig[] = [
  {
    id: 'TransactionType',
  ...
  },
  {
    ...
    required: true,
    initialValue: '',
    validation: Yup.string().required('Quotation Number is required'),
  },
  {
    id: 'TransactionDate',
...
export const QuotationDetailsConfig: FieldConfig[] = [
  {
    id: 'ItemType',
    label: 'Item Type',
    type: 'select',
